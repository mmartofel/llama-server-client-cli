...
OPENAI_API_KEY = 'not-required'  # TODO: set your OpenAI API key here


@ui.page('/')
def main():

    llm = ChatOpenAI(base_url="http://localhost:8000/v1",model_name='davinci-002', streaming=True, openai_api_key=OPENAI_API_KEY)
